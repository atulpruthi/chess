...
exports.getRecentGames = exports.getMatchHistory = exports.getGameById = void 0;
...
const getMatchHistory = async (req, res) => {
    try {
        ...
        const history = await GameService_1.gameService.getMatchHistory(userId, page, limit, timeControl);
        res.json(history);
    }
    catch (error) {
