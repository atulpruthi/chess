...
class EloService {
  ...
  private readonly K_FACTOR = 32; // Standard for most chess platforms
  private readonly K_FACTOR_NEW = 40; // For players with < 30 games
  private readonly K_FACTOR_HIGH = 24; // For players rated > 2400
  ...
  calculateNewRatings(
    ...
    whiteGamesPlayed: number = 100,
    blackGamesPlayed: number = 100
  ): EloResult {
